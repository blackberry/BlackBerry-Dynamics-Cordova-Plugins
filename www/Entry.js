    ...
    var success = function (entry) {
        if (entry) {
            if (successCallback) {
                ...
                var result = (entry.isDirectory) ? new (require('./DirectoryEntry'))(entry.name, entry.fullPath, fs, entry.nativeURL) : new (require('cordova-plugin-bbd-file.FileEntry'))(entry.name, entry.fullPath, fs, entry.nativeURL);
