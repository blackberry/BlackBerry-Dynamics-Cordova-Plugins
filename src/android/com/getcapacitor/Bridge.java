...
public class Bridge {
    ...
    private Bridge(
        ...
        CordovaResourceApi resourceApi = new CordovaResourceApi(this.context, pluginManager);
        ...
        bbdCordovaWebViewEngine.init(null, cordovaInterface, null,resourceApi, pluginManager, nativeToJsMessageQueue);
        ...
        this.loadWebView(bbdCordovaWebViewEngine);
    }
    ...
    private void loadWebView(BBDCordovaWebViewEngine bbdCordovaWebViewEngine) {
        ...
        if (!isDeployDisabled() && !isNewBinary()) {
            SharedPreferences prefs = getContext()
                .getSharedPreferences(com.good.gd.cordova.capacitor.WebView.WEBVIEW_PREFS_NAME, Activity.MODE_PRIVATE);
            String path = prefs.getString(com.good.gd.cordova.capacitor.WebView.CAP_SERVER_PATH, null);
    ...
    private boolean isNewBinary() {
        ...
        if (!versionCode.equals(lastVersionCode) || !versionName.equals(lastVersionName)) {
            ...
            editor.putString(com.good.gd.cordova.capacitor.WebView.CAP_SERVER_PATH, "");
            editor.apply();
            return true;
        }
        return false;
    ...
    private void registerAllPlugins() {
        this.registerPlugin(com.good.gd.cordova.capacitor.WebView.class);
    ...
    public static class Builder {
        ...
        public Bridge create() {
            ...
            WebView webView = this.fragment != null ? fragment.getView().findViewById(R.id.bbwebview) : activity.findViewById(R.id.bbwebview);
