 ...
 *
 * @see com.good.gd.apache.http.entity.mime.MultipartEntityBuilder
 *
 * @since 4.0
 */
public class InputStreamBody extends com.good.gd.apache.http.entity.mime.content.InputStreamBody {
    ...
    public InputStreamBody(final InputStream in, final ContentType contentType, final String filename, OnProgressEvent progressEvent) {
        ...
        this.contentLength = -1; // enable to send Transfer-Encoding:chunked
    }
